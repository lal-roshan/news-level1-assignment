...
export class NewsService {
  ...
  private readonly api_key: string = "ae9d31dc385f49428d73cc27ac4dea15";

  public trending_news_api_url: string = "https://newsapi.org/v2/top-headlines?country=in&apikey="
    + this.api_key + "&page=1/";

  private readonly bookmarks_url: string = "http://localhost:3000/news/";
